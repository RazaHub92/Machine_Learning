...
# Author: A.R.
# Usage: python main2.py -step 0.05 -As Bi -Bs Ti,Ce,Zr,Y,Yb
...
class Compound:
    ...
    def plot_correlations(self, train_X, train_y):
        ...
        plt.savefig("./data/pearson_correlation_matrix 1.png", dpi=300)
...
if __name__ == '__main__':
    ...
    DTC = DecisionTreeClassifier(random_state=1, max_features= 'auto', max_depth=None)
    adaboost_classifier = AdaBoostClassifier(base_estimator=DTC)
# Define parameter grid for hyperparameter tuning
param_grid = {
    'n_estimators': [200, 250, 300],
    'learning_rate': [1, 2, 3],
    'random_state': [0.1, 0.5, 1]
}
grid_search = GridSearchCV(estimator=adaboost_classifier, param_grid=param_grid, cv=10)
